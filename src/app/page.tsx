      ...
      <section>
        <MaxWidthWrapper className="py-24">
          ...
          <ul className="mx-auto mt-12 w-fit max-w-prose space-y-2 sm:text-lg">
            <li className="w-fit">
              <Check className="h-w mr-1.5 inline w-5 text-green-600" />
              High-quality silicone material
            </li>
            <li className="w-fit">
              <Check className="h-w mr-1.5 inline w-5 text-green-600" />
              Scracth and finterprint resistant coating
            </li>
            <li className="w-fit">
              <Check className="h-w mr-1.5 inline w-5 text-green-600" />
            ...
            <li className="w-fit">
              <Check className="h-w mr-1.5 inline w-5 text-green-600" />5 year
              print warranty
            </li>
