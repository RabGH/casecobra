...
// this is the client side way of using search params to get the orderId from the url, while the other pages use a prop in their server side component page
const ThankYou = () => {
